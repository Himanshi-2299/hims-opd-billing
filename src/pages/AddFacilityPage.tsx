...
// Add Facility Page - Create new facility with validation
...
export function AddFacilityPage() {
  ...
  // Generate and memoize facility ID on component mount
  const facilityId = React.useMemo(() => generateFacilityId(), [facilities.length]);
  ...
  const validateForm = () => {
    ...
    // Validate facility email
    if (!formData.facilityEmail.trim()) {
      newErrors.facilityEmail = "Facility email is required.";
    } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.facilityEmail)) {
      newErrors.facilityEmail = "Please enter a valid email address.";
    }
  ...
  const handleAddFacility = () => {
    if (validateForm()) {
      const newId = String(facilities.length + 1);
      ...
      const newFacility = {
        ...
        emergencyCharges: formData.emergencyCharges,
  ...
  const isFormValid = formData.facilityName.trim() !== "" &&
    formData.facilityEmail.trim() !== "" &&
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={handleAddFacility} disabled={!isFormValid}>
            Add Facility
          </Button>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.facilityName && <p className="text-red-500" style={{ fontSize: "var(--text-xs)" }}>{errors.facilityName}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.facilityEmail && <p className="text-red-500" style={{ fontSize: "var(--text-xs)" }}>{errors.facilityEmail}</p>}
              </div>
            </div>
